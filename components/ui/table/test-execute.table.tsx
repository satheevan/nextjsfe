  ...
  function MultiColorProgressbar(
    ...
    return (
      <div className="w-full flex bg-gray-200 rounded-full h-6 dark:bg-gray-700">
        <div
          className="bg-greenClr h-6 rounded-full rounded-e-none flex justify-center items-center"
          style={{ width: `${value1}%` }}
        >
          <span className="text-white text-xs font-thin">{`${value1}%`}</span>
        </div>
        <div
          className="bg-redClr h-6 flex justify-center items-center"
          style={{ width: `${value2}%` }}
        >
          <span className="text-white text-xs font-thin">{`${value2}%`}</span>
        </div>
        <div
          className="bg-yellowClr h-6 rounded-e-full flex justify-center items-center"
          style={{ width: `${value3}%` }}
        >
